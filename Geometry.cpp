...
namespace Geometry{
    ...
    public:
        ...
        //@methods
        int pointFromCircle(point<double> p){
    ...
    double findAngle(point<double> a,point<double> o,point<double> b){ //return /_AOB
        Vector<double> oa{o,a},ob(o,b);
        return acos(oa.dot(ob)/(oa.mag()*ob.mag()));
    }
}